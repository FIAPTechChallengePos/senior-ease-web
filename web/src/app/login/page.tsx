...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center py-6">
      <div
        className={clsx(
          "w-full max-w-md rounded-xl border-2 border-[var(--border-strong)] bg-[var(--surface)] shadow-md",
          "p-6 sm:p-8",
          isLargeElements ? "space-y-6" : "space-y-4"
        )}
      >
        <header>
        ...
        <section aria-labelledby="login-a11y-title" className="rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] p-4">
          ...
          <div className={clsx("mt-3 flex flex-col", isLargeElements ? "gap-4" : "gap-3")}>
            <div>
              <p className="mb-2 text-a11y-base font-medium text-[var(--text)]">Tamanho dos elementos</p>
        ...
        <form onSubmit={handleSubmit} className={clsx(isLargeElements ? "space-y-5" : "space-y-4")}>
          <div>
